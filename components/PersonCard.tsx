...
const PersonCard = ({ user }: SingleUserProps) => {
  return (
    <div className="rounded-2xl w-[96vw] m-[2vw] border-[#C8C8C8] border-[1.5px] shadow-md bg-gradient-to-tl from-[#333333] via-[#2b0276] to-[#003961]">
      <div className="p-8 pl-10 flex flex-row items-center">
        ...
        <div className="flex flex-col pl-[2vw]">
          ...
          <span className="italic font-light text-[1.2rem] text-white">{user.designation}</span>
        </div>
      </div>
